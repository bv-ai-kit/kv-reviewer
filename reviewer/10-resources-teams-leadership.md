...
Here's the secret nobody tells the textbook: a project doesn't get done by a Gantt chart — it gets done by **people**, and people are messy, motivated, anxious, brilliant, and human. You already know this. You've spent years reading the room on a discovery call, sensing when a prospect was hesitating, knowing which teammate to loop in to close.

That instinct is the single most transferable thing you own. In sales you orchestrated SDRs, AEs, and sales engineers to land a deal nobody could close alone. In project management we just call that **cross-functional team leadership**, and it's the heart of this module. Let's give your instincts a vocabulary.

---

## 🧱 Resources: people *and* things

In the PMBOK Guide world, **resources** come in two flavors, and a good PM manages both:
...
The work splits naturally into three verbs you'll see again and again:
...
- **For things:** procure equipment and materials so they arrive *just before* you need them — not so early they sit idle and not so late they stall the work.

> Think of acquisition like staffing a deal: you don't pull in the solutions engineer for every cold call, but you'd better have them on the demo. Right person, right moment.
...
- **Team-building activities** to build trust (this maps directly to Tuckman, below).
...
A useful signal of success: **team performance assessments** — are individual skills improving, is turnover dropping, is the team self-correcting without you?

### 3. Manage

The ongoing, day-to-day part: tracking performance, giving feedback, **resolving conflict**, and influencing the team to keep delivering. This is where leadership style and emotional intelligence (later in this module) earn their keep.

> 🔁 **Sales → PM bridge:** Acquiring resources is just **resource negotiation** — the same muscle you used haggling for SE hours or marketing-development funds to support a big account. You're trading priorities with another manager who has their own quota. Lead with their interests, not just yours.

---

## 📋 The RACI matrix (responsibility assignment)

Ambiguity is a project killer. The fastest way to prevent "I assumed someone else had it" is a **RACI matrix** — a type of **Responsibility Assignment Matrix (RAM)** that maps *who does what* across every activity.
...
Read a row left to right and you instantly know the chain of ownership. Read a column top to bottom and you can spot someone who's overloaded (too many `R`s) or a ghost (all `I`s — do they need to be on the project at all?).

> 🔁 **Sales → PM bridge:** A RACI is your **deal team map** in disguise. On a complex sale you knew the AE *owned* the number (Accountable), the SE *ran* the demo (Responsible), legal got *consulted* on terms, and your VP wanted to be *informed* at each stage. Same matrix, different game.

---

## 🌱 Tuckman's stages of team development

Teams don't show up "performing." Psychologist Bruce **Tuckman** described five predictable stages every team moves through. Knowing where you are tells you exactly what to do.
...
The big mindset shift: **Storming is normal and necessary** — it's not a sign you failed. A team that never storms is often a team that's avoiding the hard conversations. Your job isn't to prevent storming; it's to move them *through* it.

> 🔁 **Sales → PM bridge:** Remember onboarding a new sales pod — the awkward first week (Forming), the turf battles over accounts (Storming), the moment the team finally clicked and started covering for each other (Performing)? You've already led people through Tuckman. You just didn't have the word for it.

---

## 🧭 Leadership styles

There's no single "best" leadership style — there's the style that fits **this person, this task, this moment**. But for modern project work, especially Agile, one style stands above the rest.

### Servant leadership (the headline act)

A **servant leader** flips the org chart. Instead of "the team works for me," it's **"I work for the team."** Your job is to **remove impediments**, shield the team from distractions, grow their skills, and create the conditions for them to do their best work.

The Scrum Master role (2020 Scrum Guide) is explicitly described as a servant leader / "true leader who serves." Core servant-leadership behaviors:

- **Listen** first, prescribe second.
- **Coach** rather than command.
- **Remove blockers** so the team keeps flowing.
- **Build trust** and psychological safety.
- **Grow people** — measure success by their growth, not your visibility.

### Situational leadership (the dial you turn)

**Situational leadership** says: adapt your style to the **competence and commitment** of the person on a given task. New person on an unfamiliar task? Direct closely. Seasoned pro who's done it a hundred times? Delegate and get out of the way.
...
> 🔁 **Sales → PM bridge:** The best sales managers you ever had weren't the ones barking quotas — they were the ones who **unblocked** you: got the discount approved, removed the bureaucratic hurdle, coached you through the tough call. That's servant leadership. You felt the difference. Now be that for your team.

---

## 🔥 Motivation theories, made practical

Theory only matters if it changes what you *do* on Monday morning. Here are the three classics with the practical move attached.

### Maslow's Hierarchy of Needs

People are motivated by the lowest **unmet** need. You can't inspire someone with a grand vision if they're worried about job security.
...
**Practical move:** If a teammate seems checked out, ask *which level is unmet*. Fear of layoffs (Safety)? Feeling excluded (Belonging)? No recognition (Esteem)? Treat the actual gap.

### Herzberg's Two-Factor Theory

Herzberg split work factors into two groups that do **different jobs**:
...
**The key insight:** Fixing hygiene factors only gets you to *neutral* — a fair salary stops people from being unhappy, but it doesn't make them *driven*. Real motivation comes from the right-hand column. **You can't pay someone into engagement; you grow them into it.**

### McGregor's Theory X and Theory Y

Two opposite assumptions a manager can hold about people:
...
**Practical move:** How you *assume* people behave shapes how you manage — and becomes self-fulfilling. Lead with **Theory Y** (trust by default), and you'll get servant-leadership behaviors naturally. Micromanage on Theory X, and you'll create the very disengagement you feared.

> 🔁 **Sales → PM bridge:** Commission is a **hygiene-flavored motivator** — necessary, but you knew the reps who lit up weren't chasing the check alone; they wanted the leaderboard top spot (Esteem) and to close the deal nobody thought was winnable (Achievement). Same psychology, now pointed at delivery instead of quota.

---

## ⏸️ Pause & reflect

This is a natural breakpoint — a genuinely safe place to close the laptop, refill the coffee, and come back later. Your brain will consolidate this better with a break than by pushing through.

Before you go, sit with one or two of these:
...
- Which **motivation level** (Maslow) or **factor** (Herzberg) is most unmet for *you* right now in this career change? Naming it helps.
- Were the best managers you've had **Theory X or Theory Y**? How did it feel to be on the receiving end?

No rush. The next section will be here when you are.
...
Conflict is inevitable — and not always bad. Research on project teams points to common root causes, often ranked roughly like this:
...
Notice **personality conflict is the least common source** — most "people problems" are really *structural* problems (unclear priorities, scarce resources) wearing a personality mask. Fix the structure and the "personality clash" often evaporates.

**Five ways to handle conflict** (good to know by name):
...
Distributed teams gain talent and flexibility but lose the hallway. Your job is to **rebuild the missing context**:
...
- Be deliberate about **inclusion** across time zones — rotate meeting times so it's not always the same region at midnight.
- Invest extra in **trust and belonging** (Maslow's middle); it doesn't form by accident on a screen.
- Use the right tools and watch for the quiet voices who get steamrolled in video calls.

### Emotional intelligence (EQ)

**Emotional intelligence** is your ability to perceive, understand, and manage emotions — yours and others'. It's the connective tissue under everything in this module. The classic four domains:
...
> 🔁 **Sales → PM bridge:** Reading the room is **social awareness**. Staying composed when a prospect went cold is **self-management**. Knowing when to push and when to listen is **relationship management**. You have been training your EQ on every call for years — it is arguably your strongest PM asset already.
...
In a **matrix organization** (very common), team members report to *both* you and their functional manager — which is exactly why your negotiation and influence skills matter so much. You often lead people you don't formally own. Welcome to project management; sound familiar from coordinating a deal team across departments?
...
A **supporting / coaching** style — high on relationship support, lower on task direction. They have the competence; they need encouragement and confidence, not micromanagement.
</details>
...
**Build a RACI for something you already know.** Pick a small, real cross-functional effort — onboarding a new hire, launching a webinar, or shipping a feature.

1. List **4–6 activities** down the left column.
2. List the **people / roles** across the top.
3. Fill each cell with **R, A, C, or I**.
4. Now audit it: Does **every row have exactly one A**? Does every row have at least one **R**? Is anyone all **I** (do they belong here)? Is anyone drowning in **R**s?

Then do the same exercise *retroactively* for a past sales deal you closed. You'll see you've been building RACIs in your head for years — you just never wrote them down. That's the whole leap this module is asking you to make: take the instinct, make it explicit.
