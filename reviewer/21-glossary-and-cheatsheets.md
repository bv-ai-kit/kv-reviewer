...
flowchart TD
    ...
    INT --> INT1["Charter"]
    INT --> INT2["Change control"]
    INT --> INT3["Lessons learned"]

    SCO --> SCO1["WBS"]
    SCO --> SCO2["Scope creep"]
    SCO --> SCO3["Acceptance criteria"]

    SCH --> SCH1["Critical path"]
    SCH --> SCH2["Float"]
    SCH --> SCH3["Gantt chart"]

    COST --> COST1["EVM"]
    COST --> COST2["CPI and SPI"]
    COST --> COST3["EAC"]

    RISK --> RISK1["Risk register"]
    RISK --> RISK2["EMV"]
    RISK --> RISK3["Risk responses"]

    AGILE --> AG1["Scrum"]
    AGILE --> AG2["Kanban"]
    AGILE --> AG3["Backlog and velocity"]

    PEOPLE --> PPL1["Stakeholders"]
    PEOPLE --> PPL2["RACI"]
