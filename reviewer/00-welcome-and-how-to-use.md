...
```mermaid
flowchart LR
    Root["Sales to PM Reviewer"]
    Root --> P1["Foundations"]
    Root --> P2["Core delivery"]
    Root --> P3["People and communication"]
    Root --> P4["Agile, tools and metrics"]
    Root --> P5["Career launch"]
    Root --> P6["Reference and practice"]

    P1 --> P1a["Welcome and method"]
    P1 --> P1b["What PM really is"]
    P1 --> P1c["Project life cycle"]
    P1 --> P1d["Roles and stakeholders"]

    P2 --> P2a["Scope"]
    P2 --> P2b["Schedule"]
    P2 --> P2c["Cost and budget"]
    P2 --> P2d["Quality"]
    P2 --> P2e["Risk"]

    P3 --> P3a["Leadership and teams"]
    P3 --> P3b["Communication"]
    P3 --> P3c["Stakeholder engagement"]

    P4 --> P4a["Agile and Scrum"]
    P4 --> P4b["PM software"]
    P4 --> P4c["Metrics and reporting"]

    P5 --> P5a["Certifications"]
    P5 --> P5b["Resume and portfolio"]
    P5 --> P5c["Interview prep"]

    P6 --> P6a["Glossary"]
    P6 --> P6b["Formulas"]
    P6 --> P6c["Practice questions"]
```
...
```mermaid
flowchart TD
    Start([You start here]) --> Read[Read the module]
    Read --> Recall[Do the Check yourself quiz out loud]
    Recall --> Teach[Teach the big idea to someone in 2 to 3 sentences]
    Teach --> Try[Do the Try it exercise]
    Try --> Pause["Pause and rest (let it sink in)"]
    Pause --> Space[Re-quiz this module a day or two later]
    Space --> Next{"Feeling solid?"}
    Next -->|Yes| Advance["Move to the next module"]
    Next -->|Not yet| Read
