...
```mermaid
flowchart TD
    Start(["▶ Start: Module 00 — Welcome"])
    subgraph P1["Part 1 · Foundations"]
        direction LR
        M01["01 What PM really is"] --> M02["02 From sales to PM"] --> M03["03 Life cycle and process groups"] --> M04["04 Predictive, agile and hybrid"]
    end
    subgraph P2["Part 2 · Core delivery knowledge"]
        direction LR
        M05["05 Initiation and charter"] --> M06["06 Scope"] --> M07["07 Schedule"] --> M08["08 Cost and budget"] --> M09["09 Quality"] --> M12["12 Risk"] --> M14["14 Procurement"]
    end
    subgraph P3["Part 3 · People and communication"]
        direction LR
        M10["10 Teams and leadership"] --> M11["11 Communication"] --> M13["13 Stakeholders"] --> M18["18 Negotiation and conflict"]
    end
    subgraph P4["Part 4 · Agile, tools and metrics"]
        direction LR
        M15["15 Agile and Scrum"] --> M16["16 Tools"] --> M17["17 Metrics and reporting"]
    end
    subgraph P5["Part 5 · Career launch"]
        direction LR
        M19["19 Certifications"] --> M20["20 Landing the job"]
    end
    subgraph P6["Reference and practice"]
        direction LR
        M21["21 Glossary and cheat sheets"]
        M22["22 Study plan and capstone"]
    end
...
```mermaid
flowchart LR
    A["Read a module"] --> B["Try the one small exercise"]
    B --> C["Take the no-grades quiz"]
    C --> D{"Feeling it?"}
    D -->|"Yes"| E["Tick it off and turn the page"]
    D -->|"Not yet"| F["Re-read the part that wobbled"]
    F --> C
